...
public class Medic { 
 ...
 System.out.println(doctorList +"are Doctors of"+ hosp.getHospName()); 
 ...
 System.out.println("First doctor: "+ doctorList.get(0).getDoctorName()+ " "+doctorList.get(0).getBday()); 
...
//  Size of list:3 
// [Dr.Abu Ali, Dr.Kim Lee, Dr.Nadela A/P Ram]are Doctors of HSA 
// Display list: [Dr.Abu Ali, Dr.Nadela A/P Ram] 
// Display list: [Dr.Badariah,Dr.Abu Ali, Dr.Nadela A/P Ram,Dr.Zang Yu] 
// Doctor list and their birthday: 
// First doctor: Dr.Abu Ali 1980,12,1 
// Second doctor: Dr.Nadela A/P Ram 1985,12,12 
// Third doctor : Dr.Badariah 1984,5,8 
// Forth doctor: Dr.Zang Yu 1982,22,5 